...
const styles = StyleSheet.create({
  ...
  name: { fontFamily: "DMSans_500Medium", fontSize: 13 },
  sha: { fontFamily: "DMSans_500Medium", fontSize: 10, marginTop: 5 },
  current: { fontFamily: "DMSans_700Bold", fontSize: 9, letterSpacing: 0.8 },
  hint: { fontFamily: "DMSans_400Regular", fontSize: 11, lineHeight: 16, paddingHorizontal: 4 },
});
