...
const styles = StyleSheet.create({
  ...
  noticeText: { flex: 1, fontFamily: "DMSans_400Regular", fontSize: 12, lineHeight: 18 },
  ...
  pasteText: { flex: 1, fontFamily: "DMSans_400Regular", fontSize: 11, lineHeight: 17 },
  ...
  savedNoticeText: { fontFamily: "DMSans_500Medium", fontSize: 11, lineHeight: 16 },
  ...
  hidden: { fontFamily: "DMSans_400Regular", fontSize: 10, marginTop: 5 },
