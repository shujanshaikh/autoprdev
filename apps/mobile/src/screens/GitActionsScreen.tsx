...
const styles = StyleSheet.create({
  ...
  branchName: { fontFamily: "DMSans_500Medium", fontSize: 13 },
  branchStatus: { fontFamily: "DMSans_400Regular", fontSize: 10, marginTop: 5, textTransform: "capitalize" },
  ...
  operationTitle: { fontFamily: "DMSans_500Medium", fontSize: 12 },
  operationText: { fontFamily: "DMSans_400Regular", fontSize: 10, marginTop: 4, textTransform: "capitalize" },
  failedOperation: { gap: 8 },
  summaryLine: { marginTop: 3, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  sectionTitle: { fontFamily: "DMSans_700Bold", fontSize: 15, letterSpacing: -0.3 },
  stats: { flexDirection: "row", gap: 8 },
  stat: { fontFamily: "DMSans_700Bold", fontSize: 11 },
  actionOptions: { gap: 7 },
  ...
  actionDescription: { fontFamily: "DMSans_400Regular", fontSize: 10, lineHeight: 15, marginTop: 4 },
  ...
  inputLabel: { fontFamily: "DMSans_700Bold", fontSize: 9, letterSpacing: 1.1, marginBottom: 7, marginLeft: 2 },
  commitInput: { minHeight: 92, maxHeight: 150, borderRadius: 13, borderWidth: 1, padding: 12, fontFamily: "DMSans_400Regular", fontSize: 13, lineHeight: 19, textAlignVertical: "top" },
  pullRequestFields: { gap: 12 },
  singleInput: { height: 46, borderRadius: 12, borderWidth: 1, paddingHorizontal: 12, fontFamily: "DMSans_400Regular", fontSize: 13 },
  prBodyInput: { minHeight: 104, maxHeight: 190, borderRadius: 12, borderWidth: 1, padding: 12, fontFamily: "DMSans_400Regular", fontSize: 13, lineHeight: 19, textAlignVertical: "top" },
  ...
  fileStat: { fontFamily: "DMSans_700Bold", fontSize: 9 },
  unavailable: { minHeight: 100, alignItems: "center", justifyContent: "center", gap: 8 },
  unavailableText: { fontFamily: "DMSans_400Regular", fontSize: 11 },
});
