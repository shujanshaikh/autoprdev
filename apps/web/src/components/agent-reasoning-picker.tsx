  ...
  return (
    ...
    >
      <SelectTrigger
        ...
        className="shrink-0 gap-1.5 border-0 bg-transparent px-1.5 text-xs font-medium text-muted-foreground shadow-none hover:bg-muted/65 hover:text-foreground focus-visible:ring-1 focus-visible:ring-ring/40 data-[size=sm]:h-7 dark:bg-transparent dark:hover:bg-muted/65 [&_svg]:size-3.5"
      >
      ...
      <SelectContent
        ...
        side="top"
        sideOffset={8}
        className="w-44 rounded-xl border-border bg-popover p-1 text-popover-foreground"
      >
