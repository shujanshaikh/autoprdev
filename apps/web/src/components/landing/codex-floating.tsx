  ...
  return (
    ...
    >
      <button
        ...
        className="relative flex size-14 cursor-pointer items-center justify-center bg-primary text-primary-foreground shadow-[0_12px_40px_-8px_rgb(0_0_0/_0.35)] ring-2 ring-primary/30 transition hover:ring-primary/55 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      ...
      <section
        ...
        className={cn(
          "absolute bottom-[calc(100%+14px)] left-0 w-[min(calc(100vw-2rem),280px)] border border-border bg-popover/95 p-4 text-popover-foreground shadow-2xl backdrop-blur-md transition duration-200 ease-out",
          mobileOpen
      ...
      >
        ...
        <p className="mt-2 text-sm font-semibold text-popover-foreground">Bring your own Codex</p>
