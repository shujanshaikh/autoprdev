...
/** Compact ChatGPT-style mark used by the default button UI. */
export function ChatGPTMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 256 256" width="18" height="18" fill="currentColor" aria-hidden="true" {...props}>
...
/** @deprecated Use {@link ChatGPTMark}. Kept to avoid breaking existing imports. */
