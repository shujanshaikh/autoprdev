...
/** Direct OpenAI windows must not retain a reference to the application. */
export const CHATGPT_VERIFICATION_POPUP_FEATURES =
  `${CHATGPT_LOGIN_POPUP_FEATURES},noopener`;
